...
const items: NavItem[] = [
    ...
    },
    {
        ...
        icon: (props) => (
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" aria-hidden="true" {...props}>
                <path strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" d="M9 17v-6m6 6V7M4 21h16" />
            </svg>
        )
    },
    {
    ...
    },
    {
        ...
        icon: (props) => (
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" aria-hidden="true" {...props}>
                <path strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" d="M4 18l6-6 4 4 6-6" />
            </svg>
        )
    },
    {
        ...
        icon: (props) => (
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" aria-hidden="true" {...props}>
                <path strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" d="M12 16V4m0 0l-4 4m4-4l4 4M4 20h16" />
            </svg>
        ), 
        roles: ['Consultant']
    },
    {
        ...
        icon: (props) => (
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" aria-hidden="true" {...props}>
                <path strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" d="M5 7h14M5 12h14M5 17h14" />
            </svg>
        )
    },
    {
        ...
        <nav aria-label="Sidebar" className="h-screen sticky top-0 p-3">
            <div className="mb-4 px-3 py-2 rounded-2xl bg-gradient-to-r from-deep-navy to-cobalt text-white shadow-soft flex items-center justify-between gap-2">
                ...
                <div className="flex items-center gap-2">
                    ...
                    >
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" className={["h-5 w-5 transition-transform", collapsed ? 'rotate-180' : ''].join(' ')} aria-hidden="true">
                            <path strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" d="M10 6l6 6-6 6" />
                        </svg>
                    </button>
                </div>
            </div>
